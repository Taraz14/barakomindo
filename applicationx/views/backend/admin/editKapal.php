        ...
        <form action="" method="post" id="form-kapal">
          ...
          <div class="box-body">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="nama_kapal" placeholder="Nama Kapal" value="<?= $kapal->nama_kapal; ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="nama_pemilik" class=" col-sm-2">Nama Pemilik<br><i>Ship Owner</i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="nama_pemilik" placeholder="Nama Pemilik" value="<?= $kapal->nama_pemilik; ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="kebangsaan" class=" col-sm-2">Bendera Kebangsaan<br><i>Nationality Flag</i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="kebangsaan" placeholder="Negara Kebangsaan" value="<?= $kapal->kebangsaan; ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="gt" class=" col-sm-2">Tonnase Kotor<br><i>Gross Tonnage</i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="gt" id="gt" placeholder="Gross Tonnage Value" value="<?= $kapal->gt; ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="call_sign" class=" col-sm-2">Nama Panggilan<br><i>Call Sign</i></label>
              <div class="col-sm-10">
                <input type="email" class="form-control" name="call_sign" placeholder="Call Sign" value="<?= $kapal->call_sign; ?>">
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-12">
...
<script>
  ...
  $(function() {
    $('#save').click(function() {
      ...
      $.ajax({
        type: 'post',
        url: '<?= site_url('admin/EditKapal/kapal') ?>',
        contentType: false,
        processData: false,
        dataType: 'json',
        data: data,
